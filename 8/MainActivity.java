...
public class MainActivity extends AppCompatActivity {
    com.e.a8thprgm.DatabaseHelper databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new com.e.a8thprgm.DatabaseHelper(this);
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    {
                        Toast.makeText(getApplicationContext(), "Login Unsuccessful! Please verify your Username and Password", LENGTH_SHORT).show();
                    }
                }
